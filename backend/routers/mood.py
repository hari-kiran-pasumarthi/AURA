...
# ----------------------------
@router.post("/detect")
async def detect_mood(image: UploadFile = File(...), current_user: User = Depends(get_current_user)):
...
# ----------------------------
@router.post("/log")
async def log_mood(entry: MoodEntry, current_user: User = Depends(get_current_user)):
...
# ----------------------------
@router.get("/logs")
async def get_mood_logs(current_user: User = Depends(get_current_user)):
