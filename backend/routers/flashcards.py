...
# -------------------------------------------
# ✅ NLTK Dependencies (ensure cloud support)
# -------------------------------------------
...
async def send_flashcard_email(user_email: str, title: str, count: int):
    ...
    <p style="color:gray;font-size:12px;">Auto-generated by AURA’s Study Assistant.</p>
    """
...
# -------------------------------------------
# ⚙️ Generate Flashcards (Adaptive + Email)
# -------------------------------------------
